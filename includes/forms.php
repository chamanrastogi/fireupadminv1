	...
	protected static $wtlable=2;
	  ...
	  return $res;
		...
		<div class="col-md-'.self::$wtform.'">
									<input type="text" class="form-control" name="'.$name.'" autocomplete="off" value="'.$value.'" placeholder="'.$name.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
									<input type="text" class="form-control hinditext" name="'.$name.'" autocomplete="off" value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
									<input type="password" class="form-control" name="'.$name.'" autocomplete="off" value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
									<input type="email" class="form-control" name="'.$name.'" autocomplete="off" value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
		<input type="text" class="form-control url" name="'.$name.'" id="slug_input"  autocomplete="off"  value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
		</div></div>';
		return $x;
		}
			public static function hidden($lable="", $name="", $value = "",$n)
		{
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
									<input type="text" class="form-control" name="'.$name.'" autocomplete="off" id="'.$id.'" value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
		<div class="col-md-'.self::$wtform.'">
									<input type="number" class="form-control" min="0" max="1000" name="'.$name.'" value="'.$value.'" placeholder="'.$lable.'" '. $re.'>
								</div></div>';
		return $x;
		}
		...
		public static function text_editor($lable="",$name="",$value="",$idname="",$n)
		{
		 ...
		 $res=self::checkst($n);
			...
			<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
			<div class="col-md-'.self::$wtform.'">
			<textarea name="'.$name.'" id="'.$idname.'" class="form-control" placeholder="'.$lable.'" '. $re.'>' . $value . '</textarea></div></div>';
				if($idname!='')
										{
										$x.="<script>
...
CKEDITOR.replace( '".$idname."', {
	...
	extraPlugins: 'widgetbootstrap'	
		...
		public static function textarea_hn($lable="",$name="",$value="",$idname="",$n)
		{
			...
			<label for="inputEmail3" class="col-md-'.self::$wtlable.' control-label">'.$lable.''.$res.'</label>
			<div class="col-md-'.self::$wtform.'">
			<textarea name="'.$name.'" id="'.$idname.'" class="form-control hinditext" placeholder="'.$lable.'" '.$re.'>' . $value . '</textarea></div></div>';
			return $x;
		}
	  ...
	  public static function Select_hn($lable="", $name="", $table,$t,$n)
	  {
		...
		<div class="col-md-'.self::$wtform.'">
			  ...
			  }else
		  {
			 ...
			 $v='<option value="">एक विकल्प चुनें</option>';
			  }
